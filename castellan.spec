...
Version  : 3.1.0
Release  : 43
URL      : https://files.pythonhosted.org/packages/01/9c/86f25781b88a5639c687d7d4a7c8599ce5a5ba3d7d9f222396a2461412d1/castellan-3.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/01/9c/86f25781b88a5639c687d7d4a7c8599ce5a5ba3d7d9f222396a2461412d1/castellan-3.1.0.tar.gz
...
%prep
%setup -q -n castellan-3.1.0
cd %{_builddir}/castellan-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591108870
...
cp %{_builddir}/castellan-3.1.0/LICENSE %{buildroot}/usr/share/package-licenses/castellan/294b43b2cec9919063be1a3b49e8722648424779
