...
Version  : 3.0.1
Release  : 42
URL      : https://files.pythonhosted.org/packages/c7/76/dcbe4032ddffaf9b0954e79d87c8e00958e6bcbcff68a04d61065ec264d5/castellan-3.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c7/76/dcbe4032ddffaf9b0954e79d87c8e00958e6bcbcff68a04d61065ec264d5/castellan-3.0.1.tar.gz
...
%prep
%setup -q -n castellan-3.0.1
cd %{_builddir}/castellan-3.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586808688
...
cp %{_builddir}/castellan-3.0.1/LICENSE %{buildroot}/usr/share/package-licenses/castellan/294b43b2cec9919063be1a3b49e8722648424779
