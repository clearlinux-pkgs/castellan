...
Version  : 3.0.0
Release  : 41
URL      : https://files.pythonhosted.org/packages/aa/10/fafef19d402a884068b5c651a5fe14c91739f2ea0cefed2c228ec0ddeb01/castellan-3.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/aa/10/fafef19d402a884068b5c651a5fe14c91739f2ea0cefed2c228ec0ddeb01/castellan-3.0.0.tar.gz
...
%prep
%setup -q -n castellan-3.0.0
cd %{_builddir}/castellan-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585673653
...
cp %{_builddir}/castellan-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/castellan/294b43b2cec9919063be1a3b49e8722648424779
