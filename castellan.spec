...
%prep
%setup -q -n castellan-2.0.0
cd %{_builddir}/castellan-2.0.0
...
cp %{_builddir}/castellan-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/castellan/294b43b2cec9919063be1a3b49e8722648424779
