...
Version  : 3.1.1
Release  : 44
URL      : https://files.pythonhosted.org/packages/dc/e7/3fff1f9bcb9abdac7cdebbbf09bf09cf1d2385dc893e2dfecfb8d4b6a6d5/castellan-3.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/dc/e7/3fff1f9bcb9abdac7cdebbbf09bf09cf1d2385dc893e2dfecfb8d4b6a6d5/castellan-3.1.1.tar.gz
...
%prep
%setup -q -n castellan-3.1.1
cd %{_builddir}/castellan-3.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592582470
...
cp %{_builddir}/castellan-3.1.1/LICENSE %{buildroot}/usr/share/package-licenses/castellan/294b43b2cec9919063be1a3b49e8722648424779
